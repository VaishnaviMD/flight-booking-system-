# SkyFlow Model Context Protocol (MCP) Server

This directory contains the **Model Context Protocol (MCP)** server configuration and tool specifications for the SkyFlow Flight Booking System.
...
You can run the PowerShell script `test-mcp-client.ps1` in this folder:
```powershell
